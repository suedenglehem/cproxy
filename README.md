...
I don't use lmstudo/ollama etc at home, it's either llama-server or club90's vllm running on dedicated box. on windoze box claude in vscode needs this proxy (somehow on linux it works without ! + on linux i use my crouter...). 
